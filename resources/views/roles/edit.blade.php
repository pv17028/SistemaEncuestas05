            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="nombreRol" name="nombreRol" value="{{ $rol->nombreRol }}" placeholder="Ingresa el nombre del rol" required>
                    </div>

                    <div class="form-group mb-3">
                        <label for="descripcionRol">Descripción del Rol</label>
                        <textarea class="form-control" id="descripcionRol" name="descripcionRol" placeholder="Ingresa la descripción del rol">{{ $rol->descripcionRol }}</textarea>
                    </div>
                </div>
