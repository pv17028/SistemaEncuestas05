            ...
            <div class="d-flex align-items-center title"
                ...
                @if ($encuestaCompartida->logo)
                    <img src="{{ asset('images/' . $encuestaCompartida->logo) }}" alt="Logo de la Encuesta" height="50"
                         class="me-2">
                @endif
                <h2 class="mb-0" style="color: {{ $encuestaCompartida->color_terciario ?? 'default_color' }};">{{ $encuestaCompartida->titulo }}</h2>
            </div>
            <div>
            ...
            <div class="card mb-5"
                ...
                <div class="card-body d-flex flex-column justify-content-center align-items-start">
                    ...
                    @if($encuestaCompartida->es_anonima)
                        <p class="my-auto"><strong>Esta es una encuesta anónima. Tu respuesta será registrada sin asociarla a tu usuario.</strong></p>
                    @else
                        <p class="my-auto"><strong>Esta encuesta registrará tu usuario. Tu respuesta será asociada a tu cuenta de usuario.</strong></p>
                    @endif
                </div>
            </div>
                            ...
                            @case('Preguntas mixtas')
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="otra{{ $pregunta->idPregunta }}"
                                        name="otra[{{ $pregunta->idPregunta }}]" disabled>
                                </div>
                            @break
                            ...
                            @case('Preguntas abiertas')
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="respuesta{{ $pregunta->idPregunta }}"
                                        name="respuestas[{{ $pregunta->idPregunta }}]"></textarea>
                                </div>
                            @break
                        @endswitch
                    </div>
